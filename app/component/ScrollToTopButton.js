...
const ScrollToTopButton = () => {
  ...
  const handleCall = () => {
    window.location.href = 'tel:+916289005688';
  };

  const handleWhatsApp = () => {
    const phoneNumber = '916289005688'; // without "+" and special characters
  ...
  return (
    <div className="fixed bottom-4 right-4 flex flex-col items-end space-y-3 z-50">
      ...
      <button
        onClick={handleCall}
        className="w-12 h-12 flex items-center justify-center bg-white text-black rounded-full shadow-lg hover:bg-blue-600 transition-colors duration-200"
        aria-label="Call"
        type="button"
      >
        <CallIcon />
      ...
      <button
        ...
        className="w-12 h-12 flex items-center justify-center bg-white text-black rounded-full shadow-lg hover:bg-green-600 transition-colors duration-200"
        aria-label="WhatsApp"
        type="button"
      >
        <WhatsAppIcon />
      ...
      <button
        onClick={scrollToTop}
        className={`w-12 h-12 flex items-center justify-center bg-neutral-700 text-white rounded-full shadow-lg transition-opacity duration-300 text-xl ${
